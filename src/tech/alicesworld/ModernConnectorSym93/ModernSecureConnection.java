...
public class ModernSecureConnection implements SecureConnection {
    ...
    public ModernSecureConnection(String serverHost, int port, String nokiaIAPEndpoint) throws IOException {            
        String connectionUrl = "socket://" + serverHost + ":" + port + nokiaIAPEndpoint;
        socket = (SocketConnection) Connector.open(connectionUrl);
        System.out.println("Nokia IAP text:" + nokiaIAPEndpoint);
        ...
        tlsProtocol.connect((DefaultTlsClient) tlsClient);
